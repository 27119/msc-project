    ...
    <div className="flex pt-12 px-6 md:px-20 items-center justify-center bg-hero md:h-screen overflow-hidden">
      <div className="flex flex-col gap-6 md:flex-row items-center max-w-8xl">
        <div className="w-full md:w-1/2 lg:pr-32">
          <h2 className="text-4xl lg:text-5xl text-center md:text-left text-green-900 leading-tight font-medium">{research.title}</h2>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center md:justify-start">
            <button
              onClick={() => navigate(-1)}
              className="w-full sm:w-40 px-4 py-3 rounded font-semibold text-md bg-green-500 text-white border-2 border-green-500"
            >
              Go Back
            </button>
          </div>
